...
//    public void saveInfoUser(User new_user) {
//        DatabaseReference newUserID = infoUserRef.push();
//        Log.d(TAG, "Write INFOUSER: Success");
//        newUserID.setValue(new_user);
//        infoUserRefKey.child(new_user.getUserName()).setValue(newUserID.getKey());
//    }

    public void sendRequestFriend(final String userName_receiver, final String NameOfUser_receiver) {
...
//        });
    ...
    /*    public void saveAccountGoogle(GoogleSignInAccount acct){
            if(acct != null){
