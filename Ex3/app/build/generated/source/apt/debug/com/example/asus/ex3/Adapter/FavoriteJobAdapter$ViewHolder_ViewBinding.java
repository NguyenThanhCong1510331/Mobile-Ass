...
public class FavoriteJobAdapter$ViewHolder_ViewBinding implements Unbinder {
  private FavoriteJobAdapter.ViewHolder target;

  @UiThread
  public FavoriteJobAdapter$ViewHolder_ViewBinding(FavoriteJobAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FavoriteJobAdapter.ViewHolder target = this.target;
