...
public class JobsAdapter_ViewBinding implements Unbinder {
  private JobsAdapter target;

  @UiThread
  public JobsAdapter_ViewBinding(JobsAdapter target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    JobsAdapter target = this.target;
